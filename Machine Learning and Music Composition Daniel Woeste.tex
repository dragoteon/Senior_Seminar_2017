...
\end{figure}
	...
	Neural networks offer yet another approach to using computers to generate music, this time being a determistic style of algorithm.  \todo[inline]{Need to add much more to the section on neural networks.}
